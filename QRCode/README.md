# FunctionGraph QR Code Event Function
...
For QR code generation in this sample the npm package [qrcode](https://github.com/soldair/node-qrcode) is used.
...
created as described in [../README.md](../README.md)
